		...
		<div class="container w-1000 set-color">
			...
			축구
				...
				<div class="cell w-50 right">
					조회수 ${boardDto.boardView} | 댓글 <span class="reply-count">0</span> |
					<span class="board-like"> <i class="fa-regular fa-heart"></i>
				...
				<div class="cell">
					<table class="table table-horizontal table-hover">
						<c:forEach var="boardDto" items="${list}">
							<tr
								<c:if test="${param.boardNo == boardDto.boardNo}">class="title2"</c:if>>
