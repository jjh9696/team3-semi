...
<body>
	...
	<div class="cell right">
		...
		--%>
		<c:if test="${sessionScope.loginId != null && (sessionScope.loginId == reportBoardContentDto.reportBoardWriter || sessionScope.loginLevel == '관리자')}">
		<a class="btn negative link-confirm" data-message="정말 삭제하시겠습니까?" href="delete?reportBoardNo=${reportBoardContentDto.reportBoardNo}">글삭제</a>
		</c:if>
